...
Step 1: Second, Start the R software and use the 'source' function to load the 'OWL' function.
Step 2: Finally, you could use the 'OWL' function to predict individuals' lung cancer risk by providing
            two parameters.

Arguments
data: the personal information. It must be a data frame. The description of 'data' is detailed in the 'dictionary.xlsx' file. 
wd: path to the 'data' folder.
